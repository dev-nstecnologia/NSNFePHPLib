...
class Prod {
    ...
    function setIndEscala($indEscala) {
        $this->indEscala = $indEscala;
    }

    function setCNPJFab($CNPJFab) {
        $this->CNPJFab = $CNPJFab;
    }

    function setCBenef($cBenef) {
        $this->cBenef = $cBenef;
    }
    ...
    function setDetExport($detExport) {
    ...
    function setnFCI($nFCI) {
        $this->nFCI = $nFCI;
    }

    function setRastro($rastro) {
        $this->rastro = $rastro;
    }

    function setVeicProd($veicProd) {
    ...
    function setComb($comb) {
        $this->comb = $comb;
    }

    function setnRECOPI($nRECOPI) {
